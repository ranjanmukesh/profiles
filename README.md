...
It serves as a proof-of-concept for mobile-first, constraint-driven blockchain development using free/open tools.

### Future Plans
This "Profiles" program is the foundational piece.  
I plan to **extend the app significantly** in a **separate follow-up project** (e.g., adding client-side integration, frontend, more advanced features like social profiles, verification, or cross-chain elements).  
That extension will live in its own repository — stay tuned for updates!
